...
I also build AI tooling for SAP Commerce: an agent skill and an MCP server that give coding agents platform knowledge and access to a running instance.
...
- **SAP Commerce:** Java 21, Spring, SAP Commerce (Hybris), OCC / REST, Spartacus, React, SAP CCv2
- **AI tooling:** Claude Code, MCP, GitHub Copilot, TypeScript
